    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState){
        ...
        mDatabase.collection("study area").whereEqualTo("Name",(String) markerData.get("Name")).get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
               ...
               final List<DocumentSnapshot> sdocs= task.getResult().getDocuments();

                mUpVotes.setText(sdocs.get(0).get("up rating").toString());

                mDownVotes.setText(sdocs.get(0).get("down rating").toString());
                mDatabase.collection("user").whereEqualTo("username", mUser.getEmail()).get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        ...
                        if(votes.contains(sdocs.get(0).getId())){
        ...
        mDatabase.collection("user").whereEqualTo("username", mUser.getEmail()).get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                ...
                if(favs.size()<10){
                    ...
                    if(favs.contains(docs.get(0).getId())){

                        favs.remove(docs.get(0).getId());
        ...
        mDatabase.collection("study area").whereEqualTo("Name", markerData.get("Name")).get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                ...
                final List<DocumentSnapshot> sdocs= task.getResult().getDocuments();
                 ...
                 DocumentReference doc = mDatabase.collection("study area").document(sdocs.get(0).getId());

                int rating = Integer.parseInt(sdocs.get(0).get("up rating").toString())+1;
    ...
    private void Down(){
        ...
        mDatabase.collection("study area").whereEqualTo("Name", markerData.get("Name")).get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                ...
                int rating =  Integer.parseInt(sdocs.get(0).get("down rating").toString())+1;
