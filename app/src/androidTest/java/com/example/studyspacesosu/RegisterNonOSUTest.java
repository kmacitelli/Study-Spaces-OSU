...
public class RegisterNonOSUTest {
    ...
    /*
    these tests are looking to see that there is no registration without a proper email and password. does not test for specific error messages.
     */
    @Test
    public void registerNonOsuTest() {
        ViewAction emailText= ViewActions.replaceText("ego.10@gmail.com");
        ...
        mDataBase.collection("user").whereEqualTo("username","ego.10@gmail.com" ).get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
