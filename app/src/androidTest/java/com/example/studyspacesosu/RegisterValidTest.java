...
public class RegisterValidTest {
    ...
    public void ValidTest(){
        ViewAction emailText= ViewActions.replaceText("ego.10@osu.edu");
        email.perform(emailText);
        ViewAction passwordText= ViewActions.replaceText("studying");
        ...
        mDataBase.collection("user").whereEqualTo("username","ego.10@osu.edu" ).get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
