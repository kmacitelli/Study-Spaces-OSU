...
public class RegisterNonEmailTest {
    ...
    public void registerNonEmail(){
        ...
        ViewAction emailText= ViewActions.replaceText("ego.10osu.edu");
        ...
        mDataBase.collection("user").whereEqualTo("username","ego.10osu.edu" ).get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
